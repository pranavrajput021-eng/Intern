...
app.post("/api/coach-chat", async (req, res) => {
  try {
    ...
    // Intercept anything different from our policies, returning the exact specified message
    if (!isMessageWithinPolicy(message)) {
      return res.json({
        reply: "As your dedicated Aesthetic Athlete Coach, I focus exclusively on physical training, target nutrition, and athletic performance. For questions beyond bodybuilding, fitness, and recovery, please consult a generic AI assistant."
      });
    }
